...
- Пример видео прохождения Mobile-автотестов
...
В рамках проекта реализованы UI-автотесты, проверяющие ключевые пользовательские сценарии:
