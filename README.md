...
- [Что проверяется (Mobile-тесты)](#что-проверяется-mobile-тесты)
...
- [Отчёты](#отчёты)
    ...
    - [Jira](#jira)
- [Оповещение о результатах прогона тестов в Telegram](#оповещение-о-результатах-прогона-тестов-в-telegram)
- [Пример видео прохождения Mobile-автотестов](#пример-видео-прохождения-mobile-автотестов)
